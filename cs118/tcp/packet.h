...
public:
	...
	// TCP_Packet();
	TCP_Packet(uint16_t seqnum, uint16_t acknum, uint16_t win, bool ack, bool syn, bool fin, uint8_t* data = nullptr, ssize_t data_size = PACKET_SIZE);
    ...
    uint8_t* getPacketBytes(){ return m_byte_packet; }
